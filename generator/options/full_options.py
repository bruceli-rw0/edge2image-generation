...
class FullOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=int, default=[], nargs='+', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        ...
        parser.add_argument('--do_in_training_eval', action='store_true', help='Generate images during each evaluation step.')
        
        parser.add_argument('--num_train', type=int, default=9, help='Number of images used for training, -1 means use all.')
        parser.add_argument('--num_test', type=int, default=3, help='Number of images used for evalutation, -1 means use all.')
        parser.add_argument("--train_folder", type=str, default=["./datasets/edges2shoes/train"], nargs='+', help='Directory of training data')
        parser.add_argument('--eval_folder', type=str, default='./results/', help='Where to save results.')
